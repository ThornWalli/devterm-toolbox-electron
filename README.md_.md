...
electron-?component uses updated Electron/Vue versions and build tools! 👍 The idea of this template is to keep it a really simple Electron application without unnecessary dependency overhead.
...
```bash
git clone https://github.com/Deluze/electron-?component
cd electron-?component
npm install
npm run dev
```
